...
public final class GetMe extends Table {
	...
	public static int createGetMe(FlatBufferBuilder builder,
		...
		GetMe.addLastName(builder, lastNameOffset);
		GetMe.addFirstName(builder, firstNameOffset);
		GetMe.addPassword(builder, passwordOffset);
		GetMe.addUsername(builder, usernameOffset);
		GetMe.addAdmin(builder, admin);
